...
source_valid_batch = DataLoader(opt['dataset'], opt["batch_size"], opt, evaluation = 1)
source_test_batch = DataLoader(opt['dataset'], opt["batch_size"], opt, evaluation = 3)
target_valid_batch = DataLoader(opt['dataset'], opt["batch_size"], opt, evaluation = 2)
target_test_batch = DataLoader(opt['dataset'], opt["batch_size"], opt, evaluation = 4)
